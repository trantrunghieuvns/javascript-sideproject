		...
		<>
			...
			{trailer ? (
				<div
					...
					className='z-50  w-screen overscroll-y-none fixed inset-0 bg-black/90 text-white/90 '>
					<div className='flex player items-center justify-center h-screen w-screen z-100'>
